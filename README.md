...
5. (Optional) If you want to use the Cloud9 IDE, log into AWS using the new account number and user created above. 
...
required arguments:
  ...
  -s STACK_NAME, --stack-name STA. CK_NAME
...
```
cd code
python3 run.py -s CisDemo -k DemoKey -f /home/wrobinson/.ssh/DemoKey.pem -p TrendDevOps
``` 
